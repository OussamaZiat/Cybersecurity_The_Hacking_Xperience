...
int main(int argc, char* argv[]){
	...
	printf("cmok's nthreads: %d\n", *cmok.nthreads);
	printf("cmok's nthreads through pointer: %d\n", *s1->nthreads);
	puts("=========================");
	puts("");
//
...
//	//step 4: pointers
	...
	albi = cmok;
	s2 = &albi;
// the s2=&albi performs a deep copy because we can see that the cmok keeps its members but the albi and s2 now shares the same members.
